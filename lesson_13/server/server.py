    ...
    def create_answer(self):
        ...
        while self.request_dict:
            ...
            if 'action' in message and message['action'] == 'presence' and 'time' in message and \
                    ...
                    message['user']['status'] == "Yep, I am here!":
...
def main():
    ...
    def list_users_update():
        ...
        if change_count_connection:
            main_window.active_clients_list.setModel(gui_create_model(server.database.all_users(), ['Пользователь']))
    ...
    main_window.config_btn.triggered.connect(show_config_server)
